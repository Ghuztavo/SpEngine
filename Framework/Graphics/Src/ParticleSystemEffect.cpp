...
void SpEngine::Graphics::ParticleSystemEffect::Render(const Transform& transform, const Color& color)
{
...
void SpEngine::Graphics::ParticleSystemEffect::SetTextureId(TextureId id)
{
	mTextureId = id;
}
