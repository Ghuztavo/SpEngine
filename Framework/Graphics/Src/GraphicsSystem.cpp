...
LRESULT SpEngine::Graphics::GraphicsSystem::GraphicsSystemMessageHandler(HWND window, UINT message, WPARAM wParam, LPARAM lParam)
{
...
void GraphicsSystem::Resize(uint32_t width, uint32_t height)
{
	...
	ASSERT(SUCCEEDED(hr), "GraphicsSystem: failed to crate depth stencil view");
