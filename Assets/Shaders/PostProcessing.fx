// Simple shader that applies post processing effects to a screen
...
float4 PS(VS_OUTPUT input) : SV_Target
{
    ...
    else if (mode == 7) // chromatic aberration
    {
        ...
        float4 blurChannel = textureMap0.Sample(textureSampler, input.texCoord + distortion.y * input.texCoord);
        finalColor = float4(redChannel.r, greenChannel.g, blurChannel.b, 1.0f);
